...
public class RedisUtil {
    ...
    public static RedisUtil initialize(RedisConnectionFactory connectionFactory) {
     ...
     * @return 值
     */
    public <V> V get(String key, Class<V> cls) {
    ...
    public long hGetSetSize(String key){
        try {
     ...
     * 将obj 放入发布者队列
     */
    public boolean putQueue(String key, Object value) {
        try{
